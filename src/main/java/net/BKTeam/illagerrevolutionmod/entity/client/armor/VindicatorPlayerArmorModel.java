...
public class VindicatorPlayerArmorModel extends AnimatedGeoModel<ArmorVindicatorJacketItem> {
    ...
    @Override
    public ResourceLocation getModelLocation(ArmorVindicatorJacketItem object) {
    ...
    @Override
    public ResourceLocation getAnimationFileLocation(ArmorVindicatorJacketItem animatable) {
